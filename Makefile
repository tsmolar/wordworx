...
VERSION = 1.9.0
_libcurl_config = 
abs_builddir = /local/src/x86_64/games/wordworx/wordworx.git/trunk
abs_srcdir = /local/src/x86_64/games/wordworx/wordworx.git/trunk
...
install_sh = ${SHELL} /local/src/x86_64/games/wordworx/wordworx.git/trunk/install-sh
